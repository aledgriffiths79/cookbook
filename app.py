...
# Because you set the value of MONGO_DBNAME to be "CookBook" in your environment variables. So os.getenv("MONGO_DBNAME")  will return "CookBook" as a string. the only difference is you hard coded it into line 20, rather than getting it from the environment.
